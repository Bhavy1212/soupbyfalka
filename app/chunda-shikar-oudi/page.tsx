    ...
    <div className="mayfair-page-wrapper">
      ...
      <section className="mayfair-hero-section">
        <div className="mayfair-hero-media" data-parallax="0.08">
          <img
            src="/assets/images/chunda-shikar-oudi/hero.jpg"
            alt="Chunda Shikar Oudi Udaipur panoramic view"
            loading="eager"
          />
        </div>
      </section>
      ...
      <main className="chunda-container">

        {/* 4. Featured Card with Title Overlay */}
        <section className="mayfair-featured-card chunda-featured-card reveal-item">
          <div className="mayfair-featured-media image-reveal">
            <img
              src="/assets/images/chunda-shikar-oudi/featured.jpg"
              alt="Chunda Shikar Oudi featured showcase"
              loading="lazy"
            />
          </div>
        </section>
        ...
        <section className="mayfair-info-section">
          ...
          <div className="mayfair-info-story reveal-item">
            <p>
              Through golden sunsets, hand-carved Mewari stonework, and rugged open-top safari journeys, this series celebrates the grandeur of desert royalty and intimate wilderness encounters.
            </p>
          ...
          <div className="mayfair-services-panel reveal-item">
            ...
            <p className="mayfair-services-text">
              Concept, Production Management, Creative Direction, Location Scouting, Heritage Styling, Drone Cinematography, Color Grading, Postproduction
            </p>
            <a
              href="https://chundashikaroudi.com"
              target="_blank"
              rel="noopener noreferrer"
              className="mayfair-services-link"
            >
              chundashikaroudi.com
            </a>
          </div>
        </section>

        {/* 6. Visual Gallery Showcase Flow */}
        <section className="mayfair-gallery-flow" aria-label="Chunda Shikar Oudi Photo Gallery">

          {/* Row 1: 2-Column Royal Arch Bedroom & Balcony Patio */}
          <div className="mayfair-gallery-row chunda-gallery-row1">
            <div className="mayfair-image-card chunda-card-r1-left reveal-item image-reveal">
              <img
                src="/assets/images/chunda-shikar-oudi/row1_left.jpg"
                alt="Chunda Shikar Oudi royal arched guest room with plush seating"
                loading="lazy"
              />
            </div>
            <div className="mayfair-image-card chunda-card-r1-right reveal-item image-reveal">
              <img
                src="/assets/images/chunda-shikar-oudi/row1_right.jpg"
                alt="Chunda Shikar Oudi private balcony patio overlooking the lake and hills"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 2: Medium Inset Luxury Bathtub with Lake View */}
          <div className="mayfair-gallery-row chunda-gallery-row2">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
                src="/assets/images/chunda-shikar-oudi/row2_inset.jpg"
                alt="Chunda Shikar Oudi luxury bathtub with rose petals overlooking the lake"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 3: 2-Column Sunlit Suite & Covered Terrace */}
          <div className="mayfair-gallery-row chunda-gallery-row3">
            <div className="mayfair-image-card chunda-card-r3-left reveal-item image-reveal">
              <img
                src="/assets/images/chunda-shikar-oudi/row3_left.jpg"
                alt="Chunda Shikar Oudi sunlit living lounge with traditional floral furnishings"
                loading="lazy"
              />
            </div>
            <div className="mayfair-image-card chunda-card-r3-right reveal-item image-reveal">
              <img
                src="/assets/images/chunda-shikar-oudi/row3_right.jpg"
                alt="Chunda Shikar Oudi covered outdoor terrace with stone architecture"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 4: Full Bleed Grand Palace Hall */}
          <div className="mayfair-gallery-row mayfair-gallery-bleed">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
                src="/assets/images/chunda-shikar-oudi/row4_bleed.jpg"
                alt="Chunda Shikar Oudi grand royal hall with chandeliers and stone arches"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 5: 2-Column Jungle Safari & Hillside Dining */}
          <div className="mayfair-gallery-row chunda-gallery-row5">
            <div className="mayfair-image-card chunda-card-r5-left reveal-item image-reveal">
              <img
                src="/assets/images/chunda-shikar-oudi/row5_left.jpg"
                alt="Chunda Shikar Oudi safari jeep moving through golden hour jungle foliage"
                loading="lazy"
              />
            </div>
            <div className="mayfair-image-card chunda-card-r5-right reveal-item image-reveal">
              <img
                src="/assets/images/chunda-shikar-oudi/row5_right.jpg"
                alt="Chunda Shikar Oudi outdoor dining setup overlooking the Aravalli ridge"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 6: Medium Inset Twilight Candlelit Dining */}
          <div className="mayfair-gallery-row chunda-gallery-row6">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
                src="/assets/images/chunda-shikar-oudi/row6_inset.jpg"
                alt="Chunda Shikar Oudi candlelit lakeside dining under trees at twilight"
                loading="lazy"
              />
            </div>
          </div>
