      ...
      <main className="mayfair-container">
        ...
        <section className="mayfair-next-projects">
          ...
          <div className="mayfair-next-grid">
            <Link href="/mahua-bagh" className="mayfair-next-card group">
              <div className="mayfair-next-media">
                <img src="/assets/images/mahua-bagh/asset_02_1709x786.png" alt="Mahua Bagh Kumbhalgarh" loading="lazy" />
              </div>
              <div className="mayfair-next-meta">
                <span className="mayfair-next-name">MAHUA BAGH, KUMBHALGARH</span>
                <span className="mayfair-next-arrow">→</span>
              </div>
            </Link>
            <Link href="/parallel" className="mayfair-next-card group">
              <div className="mayfair-next-media">
                <img src="/assets/images/DJI_0008.jpg" alt="Parallel Hotel Udaipur" loading="lazy" />
              </div>
              <div className="mayfair-next-meta">
