    ...
    <div className="mayfair-page-wrapper">
      ...
      <section className="mayfair-hero-section">
        <div className="mayfair-hero-media" data-parallax="0.08">
          <img
            src="/assets/images/mayfair-puri/asset_02_1710x784.png"
            alt="MAYFAIR Heritage & Waves Resort Puri panoramic view"
            loading="eager"
          />
        </div>
      </section>
      ...
      <section className="mayfair-intro-section">
        <p className="mayfair-category-tag reveal-text">Mayfair Heritage &amp; Waves Resort, Puri</p>
        <p className="mayfair-intro-statement reveal-text" data-parallax="0.02">
          MAYFAIR Puri brings together two distinct hospitality experiences along Odisha&apos;s coastline, <em>MAYFAIR Heritage</em> and <em>MAYFAIR Waves</em>. While each property carries its own character, both are connected by their <em>relationship with the sea</em> and the experience of Puri as a destination.
        </p>
      </section>
      ...
      <main className="mayfair-container">
        <section className="mayfair-featured-card reveal-item">
          <div className="mayfair-featured-media image-reveal">
            <img
              src="/assets/images/mayfair-puri/asset_09_1710x782.png"
              alt="MAYFAIR Puri featured teaser showcase"
              loading="lazy"
            />
          </div>
        </section>
        ...
        <section className="mayfair-info-section">
          <div className="mayfair-info-story reveal-item">
            <p>
              Our approach to film focused on identifying the individuality of both properties rather than treating them as one.
            </p>
            <p>
              Through atmosphere, movement and carefully directed experiences, we created films that explored their distinct personalities while building a cohesive visual language around the destination, hospitality and the moments that shape a stay by the coast.
            </p>
          </div>
        ...
        <section className="mayfair-gallery-flow" aria-label="Mayfair Puri Video Still Gallery">
          <div className="mayfair-gallery-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(16px, 2.5vw, 36px)', marginBottom: 'clamp(32px, 5vw, 72px)' }}>
            <div className="mayfair-image-card reveal-item image-reveal">
              <img src="/assets/images/mayfair-puri/asset_03_1026x473.png" alt="MAYFAIR Puri beachfront waves" loading="lazy" />
            </div>
            <div className="mayfair-image-card reveal-item image-reveal">
              <img src="/assets/images/mayfair-puri/asset_04_1026x468.png" alt="MAYFAIR Puri poolside ambiance" loading="lazy" />
            </div>
          </div>

          <div className="mayfair-gallery-row mayfair-gallery-bleed" style={{ margin: '0 -4vw clamp(32px, 5vw, 72px)' }}>
            <div className="mayfair-image-card reveal-item image-reveal">
              <img src="/assets/images/mayfair-puri/asset_12_1710x784.png" alt="MAYFAIR Waves panoramic sunset horizon" loading="lazy" />
            </div>
          </div>
          ...
          <div className="mayfair-gallery-row" style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: 'clamp(16px, 2.5vw, 36px)', alignItems: 'center', marginBottom: 'clamp(32px, 5vw, 72px)' }}>
            <div className="mayfair-image-card reveal-item image-reveal">
              <img src="/assets/images/mayfair-puri/asset_06_1026x469.png" alt="MAYFAIR Puri coastal architecture" loading="lazy" />
            </div>
            <div className="mayfair-image-card reveal-item image-reveal">
              <img src="/assets/images/mayfair-puri/asset_07_1026x471.png" alt="MAYFAIR Puri intimate interior" loading="lazy" />
            </div>
          </div>

          <div className="mayfair-gallery-row" style={{ maxWidth: '88%', margin: '0 auto clamp(48px, 6vw, 96px)' }}>
            <div className="mayfair-image-card reveal-item image-reveal">
              <img src="/assets/images/mayfair-puri/asset_13_1710x778.png" alt="MAYFAIR Puri evening reflection pool" loading="lazy" />
            </div>
          </div>
        </section>
