...
export default function DevBaghPage() {
    ...
    <div className="mayfair-page-wrapper">
      ...
      <section className="mayfair-hero-section">
        <div className="mayfair-hero-media" data-parallax="0.08">
          <img
            src="/assets/images/dev-bagh/hero.jpg"
            alt="Neemrana's Deo Bagh Gwalior panoramic view"
            loading="eager"
          />
        </div>
      </section>
      ...
      <section className="mayfair-intro-section">
        <p className="mayfair-category-tag reveal-text">NEEMRANA'S DEO BAGH / GWALIOR</p>
      ...
      <main className="devbagh-container">
        ...
        <section className="mayfair-featured-card reveal-item">
          <div className="mayfair-featured-media image-reveal">
            <img
              src="/assets/images/dev-bagh/featured.jpg"
              alt="Neemrana's Deo Bagh featured showcase"
              loading="lazy"
            />
          </div>
        </section>
        ...
        <section className="devbagh-gallery-flow" aria-label="Neemrana's Deo Bagh Photo Gallery">

          {/* Row 1: 2-Column Luxury Bath & Suite Bedroom (PDF: Left 52.5%, Right 45.9%, Gap 16px) */}
          <div className="mayfair-gallery-row devbagh-gallery-row1">
            <div className="mayfair-image-card devbagh-card-r1-left reveal-item image-reveal">
              <img
                src="/assets/images/dev-bagh/row1_left.jpg"
                alt="Dev Bagh luxury vanity bathroom with arched mirrors and garden terrace view"
                loading="lazy"
              />
            </div>
            <div className="mayfair-image-card devbagh-card-r1-right reveal-item image-reveal">
              <img
                src="/assets/images/dev-bagh/row1_right.jpg"
                alt="Dev Bagh master guest suite bedroom with sitting lounge"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 2: Medium Inset Arched Suite with Hill Views */}
          <div className="mayfair-gallery-row devbagh-gallery-row2">
            <div className="mayfair-image-card devbagh-card-r2-inset reveal-item image-reveal">
              <img
                src="/assets/images/dev-bagh/row2_inset.jpg"
                alt="Dev Bagh heritage bedroom with arched windows overlooking mountain hills"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 3: 2-Column Suite Terrace & Private Plunge Bath (PDF: Left 44.8%, Right 55.2%) */}
          <div className="mayfair-gallery-row devbagh-gallery-row3">
            <div className="mayfair-image-card devbagh-card-r3-left reveal-item image-reveal">
              <img
                src="/assets/images/dev-bagh/row3_left.jpg"
                alt="Dev Bagh suite terrace opening to mountain plunge pool"
                loading="lazy"
              />
            </div>
            <div className="mayfair-image-card devbagh-card-r3-right reveal-item image-reveal">
              <img
                src="/assets/images/dev-bagh/row3_right.jpg"
                alt="Dev Bagh vanity bathroom looking out to private terrace jacuzzi plunge pool"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 4: Full Bleed Aravalli Forest Canopy */}
          <div className="mayfair-gallery-row mayfair-gallery-bleed">
            <div className="mayfair-image-card devbagh-card-r4-bleed reveal-item image-reveal">
              <img
                src="/assets/images/dev-bagh/row4_bleed.jpg"
                alt="Dev Bagh panoramic view of mountain tree canopies"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 5: 2-Column Heritage Daybed Lounge & Dining Hall (PDF: Left 47.4%, Right 52.6%) */}
          <div className="mayfair-gallery-row devbagh-gallery-row5">
            <div className="mayfair-image-card devbagh-card-r5-left reveal-item image-reveal">
              <img
                src="/assets/images/dev-bagh/row5_left.jpg"
                alt="Dev Bagh symmetrical heritage lounge with ornate wooden daybeds"
                loading="lazy"
              />
            </div>
            <div className="mayfair-image-card devbagh-card-r5-right reveal-item image-reveal">
              <img
                src="/assets/images/dev-bagh/row5_right.jpg"
                alt="Dev Bagh elegant sunlit dining hall with banquet tables and picture windows"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 6: Medium Inset Twilight Mountain Ridge Palace */}
          <div className="mayfair-gallery-row devbagh-gallery-row6">
            <div className="mayfair-image-card devbagh-card-r6-inset reveal-item image-reveal">
              <img
                src="/assets/images/dev-bagh/row6_inset.jpg"
                alt="Dev Bagh fortress palace illuminated against twilight mountain ridge"
                loading="lazy"
              />
            </div>
          </div>
