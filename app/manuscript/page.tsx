...
export default function ManuscriptPage() {
  ...
  return (
    <div className="mayfair-page-wrapper">
      ...
      <section className="mayfair-hero-section">
        <div className="mayfair-hero-media" data-parallax="0.08">
          <img
            ...
            alt="Manuscript Udaipur luxury rooftop terrace overlooking the heritage city palace"
            loading="eager"
          />
        </div>
      </section>
      ...
      <main className="mayfair-container">
        ...
        <section className="mayfair-featured-card reveal-item">
          <div className="mayfair-featured-media image-reveal">
            <img
              ...
              alt="Grand architectural central courtyard view of Manuscript Udaipur"
              loading="lazy"
            />
          </div>
        </section>
        ...
        <section className="mayfair-info-section">
          ...
          <div className="mayfair-info-story reveal-item">
            <p>
              Visually, Nurtured Presence is brought to life through intimate, textured imagery that evokes a sense of care and belonging, while the films explore human connection through the voices of heritage architecture, the city of lakes, and its artisans. Each narrative takes viewers on a journey of freedom, discovery, and renewal, offering a moment to return to what brings peace – to feel nurtured and fully present.
            </p>

            <h3 className="mayfair-films-heading">The Three Films:</h3>
            <ol className="mayfair-films-list">
              <li>
                A couple's journey, narrated by the palace walls as they embrace the rhythm of Udaipur, doubled as a brand film for the property.
              </li>
              <li>
                An intergenerational family film, told through the voice of a local custodian reflected on the estate's deep craftsmanship.
              </li>
              <li>
                A story centred on bespoke artistic design, guided by the heritage corridors and courtyard light.
              </li>
            </ol>
          </div>
          ...
          <div className="mayfair-services-panel reveal-item">
            ...
            <a
              href="https://manuscriptudaipur.com"
              target="_blank"
              rel="noopener noreferrer"
              className="mayfair-services-link"
            >
              manuscriptudaipur.com
            </a>
          </div>
        </section>

        {/* 6. Visual Gallery Showcase Flow */}
        <section className="mayfair-gallery-flow" aria-label="Manuscript Photo Gallery">

          {/* Row 1: Asymmetric Row (Hallway Portrait + Room Interior Landscape) */}
          <div className="mayfair-gallery-row nobu-gallery-row1">
          ...
          {/* Row 2: Medium Inset Panorama (Canopy Bed Suite) */}
          ...
          {/* Row 3: Asymmetric Row (Bathroom Sink Landscape + Bathroom Door Portrait) */}
          <div className="mayfair-gallery-row nobu-gallery-row3">
            <div className="mayfair-image-card mayfair-card-landscape reveal-item image-reveal">
              <img
          ...
          {/* Row 4: Showcase Central Courtyard Balconies View (With Side Gaps) */}
          <div className="mayfair-gallery-row nobu-gallery-row4">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
          ...
          {/* Row 5: Medium Inset (Dining Room White Bench) */}
          <div className="mayfair-gallery-row mayfair-gallery-medium">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
          ...
          {/* Row 6: 2-Column Side-by-Side (Left Fireplace Lounge Smaller + Right Bar Counter Bigger) */}
          ...
          {/* Row 7: Heritage Facade Panorama View (With Increased Width) */}
          <div className="mayfair-gallery-row nobu-gallery-row7">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
      ...
      <OtherProjectsSlider currentSlug="manuscript" type={projectTab} />
