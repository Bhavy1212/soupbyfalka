      ...
      <main className="mayfair-container">
        ...
        <section className="mayfair-next-projects">
          ...
          <div className="mayfair-next-grid">
            <Link href="/manuscript" className="mayfair-next-card group">
              <div className="mayfair-next-media">
                <img src="/assets/images/luxury-a.webp" alt="Manuscript Udaipur" loading="lazy" />
              </div>
              <div className="mayfair-next-meta">
                <span className="mayfair-next-name">MANUSCRIPT, UDAIPUR</span>
                <span className="mayfair-next-arrow">→</span>
              </div>
            </Link>
            <Link href="/mayfair-puri" className="mayfair-next-card group">
              <div className="mayfair-next-media">
                <img src="/assets/images/mayfair-puri/asset_02_1710x784.png" alt="MAYFAIR Heritage & Waves Resort Puri" loading="lazy" />
              </div>
              <div className="mayfair-next-meta">
                <span className="mayfair-next-name">MAYFAIR HERITAGE &amp; WAVES RESORT, PURI</span>
                <span className="mayfair-next-arrow">→</span>
              </div>
            </Link>
          </div>
