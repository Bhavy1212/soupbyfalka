...
export default function JanuPage() {
  ...
  return (
    <div className="mayfair-page-wrapper">
      ...
      <section className="mayfair-hero-section">
        <div className="mayfair-hero-media" data-parallax="0.08">
          <img
            ...
            alt="Janu luxury resort curved infinity pool overlooking hills and forests"
            loading="eager"
      ...
      <section className="mayfair-intro-section">
        <p className="mayfair-category-tag reveal-text">JANU</p>
      ...
      <main className="mayfair-container">
        ...
        <section className="mayfair-gallery-flow" aria-label="Janu Photo Gallery">
          ...
          <div className="mayfair-gallery-row mayfair-gallery-2col">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
                ...
                alt="Janu luxury bedroom suite with light pine wood paneling and canopy bed view 1"
                loading="lazy"
              />
            </div>
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
                ...
                alt="Janu luxury bedroom suite with light pine wood paneling and canopy bed view 2"
                loading="lazy"
              />
            </div>
          </div>
          ...
          {/* Row 5: 2-Column Side-by-Side (Pool Deck + Forest Aerial View) */}
          <div className="mayfair-gallery-row mayfair-gallery-2col">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
