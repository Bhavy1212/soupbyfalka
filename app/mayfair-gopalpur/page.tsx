...
export default function MayfairGopalpurPage() {
  ...
  return (
    <div className="mayfair-page-wrapper">
      ...
      <main className="mayfair-gopalpur-container">

        {/* 4. Featured Card with Title Overlay */}
        <section className="mayfair-featured-card mayfair-gopalpur-featured-card reveal-item">
        ...
        <section className="mayfair-gallery-flow" aria-label="Mayfair Palm Beach Resort Photo Gallery">
          ...
          <div className="mayfair-gallery-row mayfair-gopalpur-gallery-row1">
          ...
          <div className="mayfair-gallery-row mayfair-gopalpur-gallery-row2">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
          ...
          {/* Row 4: Centered Inset Showcase Pool (Reduced Frame Width) */}
          <div className="mayfair-gallery-row mayfair-gopalpur-gallery-row4">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
          ...
          {/* Row 5: 2-Column Seaside Terrace & Swan Pathway (Right Bigger, Left Smaller) */}
          <div className="mayfair-gallery-row mayfair-gopalpur-gallery-row5">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
          ...
          <div className="mayfair-gallery-row mayfair-gopalpur-gallery-row6">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
      ...
      <OtherProjectsSlider currentSlug="mayfair-gopalpur" type={projectTab} />
