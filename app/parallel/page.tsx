    ...
    <div className="mayfair-page-wrapper">
      ...
      <section className="mayfair-hero-section">
        <div className="mayfair-hero-media" data-parallax="0.08">
          <img
            src="/assets/images/parallel/hero.jpg"
            alt="Parallel Hotel Udaipur panoramic view"
            loading="eager"
          />
        </div>
      </section>
      ...
      <main className="parallel-container">
        ...
        <section className="mayfair-featured-card parallel-featured-card reveal-item">
          <div className="mayfair-featured-media image-reveal">
            <img
              src="/assets/images/parallel/featured.jpg"
              alt="Parallel Hotel featured showcase"
              loading="lazy"
            />
          </div>
        </section>
        ...
        <section className="mayfair-info-section">
          ...
          <div className="mayfair-info-story reveal-item">
            <p>
              Visually, the project captures the interplay of modern hospitality and warm ambient tones. Intimate guest suites, sophisticated dining spaces, and open-air rooftop lounges invite guests to unwind and immerse in refined urban comfort.
            </p>
          ...
          <div className="mayfair-services-panel reveal-item">
            ...
            <p className="mayfair-services-text">
              Concept, Production Management, Creative Direction, Casting, Wardrobe, Interior Styling, Food & Beverage Styling, Color Grading, Postproduction
            </p>
            <a
              href="https://parallelhotel.com"
              target="_blank"
        ...
        <section className="mayfair-gallery-flow" aria-label="Parallel Hotel Photo Gallery">

          {/* Row 1: 2-Column Guest Suite & Living Area */}
          <div className="mayfair-gallery-row parallel-gallery-row1">
            <div className="mayfair-image-card parallel-card-r1-left reveal-item image-reveal">
              <img
                src="/assets/images/parallel/row1_left.jpg"
                alt="Parallel Hotel luxury guest bedroom with mountain views"
                loading="lazy"
              />
            </div>
            <div className="mayfair-image-card parallel-card-r1-right reveal-item image-reveal">
              <img
                src="/assets/images/parallel/row1_right.jpg"
                alt="Parallel Hotel living area with contemporary furnishings and portraits"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 2: Medium Inset Dusk Rooftop View */}
          <div className="mayfair-gallery-row parallel-gallery-row2">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
                src="/assets/images/parallel/row2_inset.jpg"
                alt="Parallel Hotel illuminated building against the Udaipur twilight cityscape"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 3: 2-Column Restaurant Interior & Rooftop Sunset Dining */}
          <div className="mayfair-gallery-row parallel-gallery-row3">
            <div className="mayfair-image-card parallel-card-r3-left reveal-item image-reveal">
              <img
                src="/assets/images/parallel/row3_left.jpg"
                alt="Parallel Hotel signature dining room with elegant booth seating"
                loading="lazy"
              />
            </div>
            <div className="mayfair-image-card parallel-card-r3-right reveal-item image-reveal">
              <img
                src="/assets/images/parallel/row3_right.jpg"
                alt="Parallel Hotel rooftop outdoor dining terrace at golden hour"
                loading="lazy"
              />
            </div>
          </div>

          {/* Row 4: Inset Night Rooftop Bar */}
          <div className="mayfair-gallery-row parallel-gallery-row4">
            <div className="mayfair-image-card reveal-item image-reveal">
              <img
                src="/assets/images/parallel/row4_inset.jpg"
                alt="Parallel Hotel illuminated rooftop bar and restaurant at night"
                loading="lazy"
              />
            </div>
          </div>
      ...
      <OtherProjectsSlider currentSlug="parallel" type={projectTab} />
