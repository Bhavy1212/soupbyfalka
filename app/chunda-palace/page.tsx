      ...
      <main className="mayfair-container">
        ...
        <section className="mayfair-next-projects">
          ...
          <div className="mayfair-next-grid">
            <Link href="/chunda-shikar-oudi" className="mayfair-next-card group">
              <div className="mayfair-next-media">
                <img src="/assets/images/01.jpg" alt="Chunda Shikar Oudi Udaipur" loading="lazy" />
              </div>
              <div className="mayfair-next-meta">
                <span className="mayfair-next-name">CHUNDA SHIKAR OUDI, UDAIPUR</span>
